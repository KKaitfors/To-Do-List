window.addEventListener("load", () => {
  ...
  document.getElementById("new-task-form").addEventListener("submit", (e) => {
    ...
    task_edit_btn.innerHTML = "<img class='task-button-icon' src='images/edit-mark.png'/>Edit";
    ...
    task_delete_btn.innerHTML = "<img class='task-button-icon' src='images/delete-mark.png'/>Delete";
    ...
    task_complete_btn.innerHTML = "<img class='task-button-icon' src='images/check-mark.png'/>Complete";
    ...
    task_edit_btn.addEventListener('click', () => {
      if (task_edit_btn.innerText.toLowerCase() == "edit") {
        ...
        task_input_el.focus();
        task_edit_btn.innerHTML = "<img class='task-button-icon' src='images/save-mark.png'/>Save";
      } else {
        task_input_el.setAttribute("readonly", "readonly");
        task_edit_btn.innerHTML = "<img class='task-button-icon' src='images/edit-mark.png'/>Edit";
      }
